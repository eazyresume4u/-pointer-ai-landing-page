    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <div className="w-full h-full relative overflow-hidden rounded-2xl">
          {/* Grid pattern using CSS instead of heavy SVG */}
          <div
            className="absolute inset-0 opacity-20"
            style={{
              backgroundImage: `
                linear-gradient(hsl(var(--foreground)) 0.4px, transparent 0.4px),
                linear-gradient(90deg, hsl(var(--foreground)) 0.4px, transparent 0.4px)
              `,
          ...
          <div className="absolute inset-0 bg-gradient-to-tl from-primary-light/10 via-transparent to-primary/10" />

          {/* Blur effects using CSS instead of heavy filters */}
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[200%] h-[200%] bg-primary/5 blur-[150px] rounded-full" />
          <div className="absolute top-1/3 right-1/4 w-[150%] h-[150%] bg-primary-light/10 blur-[100px] rounded-full" />
        </div>
